  ...
  let groups = $derived<Group[]>([
    {
      ...
      rows: [
        ...
        { keys: `${modKey}+Shift+Q`, label: 'Blockquote — wrap selection as `> citation`' },
    ...
    },
    {
      ...
      rows: [
        ...
        { keys: `${modKey}+Shift+/`, label: 'Ask AI about the current section (no selection needed — uses heading-bounded section under cursor)' },
