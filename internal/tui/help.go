...
var helpSections = []helpSection{
	...
	// ---------------------------------------------------------------
	{
		...
		bindings: []helpBinding{
			...
			{"Alt+M", "Morning Routine — start day with briefing and planning"},
			...
			{"", ""},
			{"", "Morning flow: Alt+M → AI briefing → review tasks → plan day"},
	...
	// ---------------------------------------------------------------
	{
		...
		bindings: []helpBinding{
			...
			{"", ""},
			{"", "VIEWS (number keys):"},
			{"1", "Today — tasks due today + overdue"},
			{"2", "Upcoming — tasks due in the next 14 days"},
			{"3", "All — every task across the vault"},
			{"4", "Completed — done tasks"},
			{"5", "Calendar — monthly calendar with task dots"},
			{"6", "Kanban — drag cards between columns"},
			{"7", "Eisenhower — urgent/important matrix"},
	...
	// ---------------------------------------------------------------
	{
		...
		bindings: []helpBinding{
			...
			{"a", "Create new event (title → time → duration → details)"},
			{"d", "Delete event (in agenda view)"},
			...
			{"", "Disabled calendars configurable in Settings."},
		},
	},
	// ---------------------------------------------------------------
	// DAILY PLANNER
	...
	// ---------------------------------------------------------------
	{
		...
		bindings: []helpBinding{
			...
			{"", ""},
			{"", "FOCUS SESSION (via task manager 'f' or command palette):"},
			...
			{"", ""},
			{"", "TIME TRACKER (via command palette):"},
	...
	// ---------------------------------------------------------------
	{
		title: "Habit Tracker",
		bindings: []helpBinding{
			{"", "Open via command palette (search 'Habit Tracker')."},
	...
	// ---------------------------------------------------------------
	{
		title: "Sidebar",
		bindings: []helpBinding{
			{"Type", "Fuzzy search files by name (auto-filters)"},
			{"Backspace", "Delete search character"},
			{"Esc", "Clear search filter"},
			{"Enter", "Open selected file"},
			{"n", "Create new folder"},
			{"", ""},
			{"", "Files sorted by: name, modified date, or size (configurable)."},
