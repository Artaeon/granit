...
func (o Onboarding) stepNavigation(w int) (string, string) {
	...
	b.WriteString("\n")
	b.WriteString(onbBinding("F1", "Jump to sidebar"))
	b.WriteString("\n")
	b.WriteString(onbBinding("F2", "Jump to editor"))
	b.WriteString("\n")
	b.WriteString(onbBinding("F3", "Jump to backlinks"))
	b.WriteString("\n\n")
...
func (o Onboarding) stepGetStarted(w int) (string, string) {
	...
	b.WriteString("\n")
	b.WriteString(onbBinding("F5", "Full help / shortcuts"))
	b.WriteString("\n")
