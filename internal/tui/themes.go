...
var builtinThemes = map[string]Theme{
	...
	"solarized-dark": {
		...
		Surface2: lipgloss.Color("#0A4556"),
		Surface1: lipgloss.Color("#073642"),
		Surface0: lipgloss.Color("#04313D"),
	...
	"solarized-light": {
		...
		Surface2: lipgloss.Color("#D6D0C3"),
		Surface1: lipgloss.Color("#E4DED2"),
		Surface0: lipgloss.Color("#EEE8D5"),
		Base:     lipgloss.Color("#FDF6E3"),
		Mantle:   lipgloss.Color("#F5EFDC"),
		Crust:    lipgloss.Color("#E6E0D3"),
		Border: "normal", Density: "compact", AccentBar: "│", Separator: "─", LinkUnderline: false,
	},
	"rose-pine": {
		Name:     "rose-pine",
	...
	"cobalt2": {
		...
		Surface0: lipgloss.Color("#1E3F54"),
