...
var AllCommands = []Command{
	...
	{Label: "Close Tab", Desc: "Close the active tab", Shortcut: "Ctrl+W", Action: CmdCloseTab, Icon: &IconFileChar, Category: CatNavigation},
	...
	{Label: "Canvas", Desc: "Visual note canvas / whiteboard", Shortcut: "", Action: CmdShowCanvas, Icon: &IconCanvasChar, Category: CatKnowledge},
